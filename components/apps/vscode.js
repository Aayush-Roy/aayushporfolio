...
export default function VsCode() {
    return (
        ...
        // <iframe src="https://github.com/Aayush-Roy/ProConnect/tree/main/frontend/src/pages" frameBorder="0" title="VsCode" className="h-full w-full bg-ub-cool-grey"></iframe>
        <iframe
  src="https://github1s.com/Aayush-Roy/ProConnect/blob/main/frontend/src/pages"
  frameBorder="0"
  title="VsCode"
