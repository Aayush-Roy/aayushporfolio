...
//                     <span className=" ml-1 md:ml-2 text-gray-50 ">About Aayush</span>
//                 </div>
...
//                     <img className=" w-3 md:w-4" alt="aayush' skills" src="./themes/Yaru/status/skills.svg" />
...
export class AboutAayush extends Component {
...
//                 <div>my name is <span className="font-bold">Aayush</span> ,</div>
...
function About() {
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" alt="Aayush Roy Logo" />
            </div>
            <div className="mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Aayush</span>,</div>
            ...
            <ul className="mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className="list-pc">
                    Coming from a <span className="font-medium">non-technical background</span>, I started my coding journey out of pure curiosity — and gradually built a strong foundation in <span className="font-medium">MERN Stack</span> and modern web technologies.
                </li>
                <li className="mt-3 list-building">
                    I love building <span className="font-medium">real-world web applications</span> that are clean, fast, and user-focused. Whether it’s crafting pixel-perfect UIs or designing scalable backends, I enjoy the entire process.
                </li>
                <li className="mt-3 list-time">
                    When I’m not coding, I’m usually exploring new tools, contributing to <span className="font-medium">open-source projects</span>, or learning about DevOps and cloud deployment.
                </li>
                <li className="mt-3 list-star">
                    I believe consistent learning and curiosity are the keys to growth — and I’m excited to keep building things that make an impact.
                </li>
            </ul>
        </>
    );
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    ...
                    <div className=" text-sm md:text-base">Bachelor's of Arts</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">CGPA &nbsp; 8.41</div>
                </li>
                {/* <li className="list-disc">
                ...
                <li className="list-disc mt-5">
                    ...
                    <div className=" text-sm md:text-base">Humanities</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">Percentage &nbsp; 84.4%</div>
                </li>
            </ul>
        </>
    )
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white" alt="vivek docker" /> */}
                        <img className="m-1" src="https://img.shields.io/badge/-JavaScript-%23F7DF1C?style=flat&logo=javascript&logoColor=000000&labelColor=%23F7DF1C&color=%23FFCE5A" alt="vivek javascript" />
<img className="m-1" src="https://img.shields.io/badge/C%2B%2B-00599C?style=flat&logo=c%2B%2B&logoColor=white" alt="vivek c++" />
<img className="m-1" src="http://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=ffffff" alt="vivek python" />

<a href="https://www.google.com/search?q=is+html+a+language%3F" target="_blank" rel="noreferrer">
  <img title="yes it's a language!" className="m-1" src="https://img.shields.io/badge/-HTML5-%23E44D27?style=flat&logo=html5&logoColor=ffffff" alt="vivek HTML" />
</a>

<img className="m-1" src="https://img.shields.io/badge/-Sass-%23CC6699?style=flat&logo=sass&logoColor=ffffff" alt="vivek SASS" />
<img className="m-1" src="https://img.shields.io/badge/-Git-%23F05032?style=flat&logo=git&logoColor=%23ffffff" alt="vivek git" />
<img className="m-1" src="https://img.shields.io/badge/-Firebase-FFCA28?style=flat&logo=firebase&logoColor=ffffff" alt="vivek firebase" />
<img className="m-1" src="https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white" alt="vivek docker" />
<img className="m-1" src="https://img.shields.io/badge/TypeScript-3178C6?style=flat&logo=typescript&logoColor=white" alt="vivek typescript" />
<img className="m-1" src="https://img.shields.io/badge/Android_Studio-3DDC84?style=flat&logo=android-studio&logoColor=white" alt="vivek android studio" />
...
<img className="m-1" src="https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white" alt="vivek flutter" />
<img className="m-1" src="https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat&logo=tailwind-css&logoColor=white" alt="vivek tailwind css" />
<img className="m-1" src="https://img.shields.io/badge/-Nodejs-339933?style=flat&logo=Node.js&logoColor=ffffff" alt="vivek node.js" />
<img className="m-1" src="https://img.shields.io/badge/jQuery-0769AD?style=flat&logo=jquery&logoColor=white" alt="vivek jquery" />
<img className="m-1" src="https://img.shields.io/badge/Redux-593D88?style=flat&logo=redux&logoColor=white" alt="vivek redux" />
<img className="m-1" src="https://img.shields.io/badge/MongoDB-4EA94B?style=flat&logo=mongodb&logoColor=white" alt="vivek mongodb" />
<img className="m-1" src="https://img.shields.io/badge/Express.js-000000?style=flat&logo=express&logoColor=white" alt="vivek express" />
<img className="m-1" src="https://img.shields.io/badge/React_Native-20232A?style=flat&logo=react&logoColor=61DAFB" alt="vivek react native" />
<img className="m-1" src="https://img.shields.io/badge/SQL-4479A1?style=flat&logo=mysql&logoColor=white" alt="vivek sql" />
<img className="m-1" src="https://img.shields.io/badge/Bootstrap-7952B3?style=flat&logo=bootstrap&logoColor=white" alt="vivek bootstrap" />
    ...
    const project_list = [
        {
            name: "Meetzy",
            date: "Sep 2025",
            link: "https://github.com/Aayush-Roy/Meetzy",
            description: [
                "Meetzy is a full-stack MERN-based real-time video calling and chat application that enables seamless peer-to-peer video and audio communication with integrated text chat functionality. ",
            ],
            domains: ["javascript", "react.js", "tailwindcss", "mongodb", "express", "socket.io", "webrtc"]
        },
        {
            name: "Leaflet Explorer",
            date: "Apr 2024",
            link: "https://github.com/Aayush-Roy/Leaflet-Explorer",
            description: [
                "A Hotel listing webp app where user can see listings write reviews and create their own",
            ],
            domains: ["javascript", "ejs", "express", "mongodb", "passport.js", "cloudinary"]
        },
        // {
        //     name: "CodeConnect",
        //     date: "Nov 2021",
        ...
        // },
        {
            name: "Refokus",
            date: "Jan 2021",
            link: "https://github.com/Aayush-Roy/Refokus",
            description: [
                "A website with stunning animation with smooth scrolling",
            ],
            domains: ["reactjs", "tailwindcss", "framer-motion"]
        },
        // {
        ...
        // },
        {
            name: "Flick Finder",
            date: "Nov 2020",
            link: "https://github.com/Aayush-Roy/FilckFinder",
            description: [
                "Developed Web Application for Movies lover",
            ],
            domains: ["javascript", "reactjs", "tailwindcss", "TMDB API"]
        },
        // {
    ...
    return (
        <>
            ...
            {/* <iframe src="https://github.com/sponsors/vivek9patel/card" title="Sponsor vivek9patel" className='my-4 w-5/6 md:w-3/4' ></iframe> */}
                <a
  href="https://github.com/sponsors/Aayush-Roy"
  target="_blank"
  rel="noreferrer"
  className="inline-block my-4 px-5 py-2 bg-[#24292e] text-white rounded-lg hover:bg-[#333] transition"
>
  💖 Sponsor on GitHub
</a>
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/aayush.pdf" title="vivek patel resume" frameBorder="0"></iframe>
    )
}